...
data_cfg = dict(
    ...
    use_gt_bbox=True,
    det_bbox_thr=0.0,
    bbox_file='/home/dx/datasets/coco/person_detection_results/'
...
model = dict(
    type='PCT_VAE',
    # pretrained='weights/heatmap/tokenizer.pth',
    backbone=dict(
    ...
    keypoint_head=dict(
        ...
        tokenizer=dict(
            guide_ratio=0.5,
            ckpt="work_dirs/pct_base_tokenizer_vae/tokenizer_epoch_2.pth",
            encoder=dict(
                drop_rate=0.2,
                num_blocks=4,
                hidden_dim=512,
